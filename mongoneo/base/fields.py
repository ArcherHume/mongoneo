...
from mongoneo.base.common import UPDATE_OPERATORS
...
from mongoneo.errors import DeprecatedError, ValidationError
from mongoneo.query_builder import QueryExpression
...
class BaseField:
    ...
    # The auto_creation_counter is used for fields that MongoNeo implicitly
